...
declare
  ...
  tests jsonb := $j$[
    ...
    {"n":"deletion: with nobody left, the conversation is removed (no orphan)","as":"admin","sql":"select 1 from public.conversations where id not in ('{conv}','{conv2}')","expect":"rows=0"},
