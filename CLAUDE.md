...
| F7 | Block and report (a block also unmatches and hides both users from each other; messages are kept) | A blocked user disappears from the feed and matches; reports are stored |
...
**Backlog (post-MVP):**
- **Phase 2 – Teams** (Elie, 2026-09-20; do NOT build now):
