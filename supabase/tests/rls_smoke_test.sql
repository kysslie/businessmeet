...
declare
  ...
  tests jsonb := $j$[
    ...
    {"n":"visibility: the real accounts were backfilled to private (no change in who sees them today)","as":"admin","sql":"select 1 from public.profiles where display_name in ('John','Ana Demo','Marco Demo') and visibility='private'","expect":"rows=3"},
