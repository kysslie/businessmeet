...
**Next planned step:** P5 — account deletion (cascades projects and links too) and the French privacy page (with the acquisition clause, marked "pending legal review"); clears DEBT-021 BLOCKER. Will present the plan and wait for Elie's OK. The French category migration (`supabase/proposed/`) and Elie's matching-related tests stay pending but are no longer blocking — they can wait until matching is re-enabled.
